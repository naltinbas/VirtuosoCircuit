...
// Apprentice: the eighth note skeleton of both violins with the continuo
// filling the rests.
const apprenticeHead: BeatEvent[] = [
  ...phrase("a1", 3.5, "4/0.5 | [1,4]! 2/1 4/0.5 4 1 1 4"),
  ...phrase("a2", 8, "4/0.5 0 1 2 3/0.75 4/0.25 2/1"),
];
const apprenticeMid: BeatEvent[] = [
  ...phrase("b1", 12, "[2,4]/0.75 3/0.25 0/0.75 3/0.25 0/0.75 1/0.25 0/0.75 4/0.25"),
  ...phrase("b2", 16, "3/0.5 2 2/1.5 2/0.5 1/1"),
  ...phrase("b3", 20, "[2,3]/0.5 1 0/1 2/0.5 1 0 1"),
  ...phrase("b4", 24, "2/0.5 3 2/0.75 3/0.25 2/0.75 4/0.25 1/1"),
];
const apprenticeClose: BeatEvent[] = [
  ...phrase("c1", 28, "[1,3]/0.5 2 1/1 3/0.5 2 1 0"),
  ...phrase("c2", 32, "0/0.5 1 2/1"),
];
const apprenticeEpisode: BeatEvent[] = [
  ...phrase("d1", 34, "1h!/1 r/0.5 4 | [1,4]! 3/1.5 0h/1.25 r/0.25 1/1 | 2/0.5 3"),
  ...phrase("d2", 41.5, "4/0.5 2 1 2 3"),
  ...phrase("d3", 44, "1/0.5 4/1 3/0.5 4 2 0 1"),
  ...phrase("d4", 48, "2/0.5 1 1 2 2 1 0/1"),
  ...phrase("d5", 52, "[2,3]/0.5 1 0/1 2/0.5 1 0 1"),
  ...phrase("d6", 56, "2/0.5 3 2/0.75 3/0.25 2/0.75 4/0.25 1/0.75 4/0.25"),
  ...phrase("d7", 60, "3/0.5 2 0 1 2h!/1 r/0.5 4"),
  ...phrase("d8", 64, "[1,4]!/0.5 2/1.5 0h/1.75 r/0.25"),
];
const apprenticeArpeggios: BeatEvent[] = [
  ...phrase("e1", 68, "1/0.5 1 2 3 1 4 4h/1 | r/0.5 4"),
  ...phrase("e2", 73, "4h/1 r/0.5 4 4h/1 | r/0.5 0 1 3"),
  ...phrase("e3", 78, "2/0.5 1 3 4"),
  ...phrase("e4", 80, "3/0.5 0 2 3 1h/1 r/0.5 1"),
  ...phrase("e5", 84, "0h!/1 r/0.5 3 2 0 1/1"),
];
const apprenticeReturn: BeatEvent[] = [
  ...phrase("f1", 88, "[1,4]/0.5 4 4/1 3/0.5 3 3 2"),
  ...
  ...phrase("f5", 104, "4h!/1 r/0.5 0 0h/1 r/0.5"),
];
...
// Virtuoso: the full figure, three notes a beat, with the pedal alternations
// charted as trills.
const virtuosoHead: BeatEvent[] = [
  ...phrase("a1", 3.5, "4/0.5 | [1,4]! 2/0.25 1/0.75 4/0.25 3"),
  ...phrase("a2", 6, "4/0.5 1/0.25 0 1/0.5 4/0.25 3"),
  ...phrase("a3", 8, "4h/0.5 r/0.25 0 1/0.5 2 3/0.25 1/0.5 3/0.25 2"),
  ...phrase("a4", 11.25, "3/0.5 4/0.25"),
];
const virtuosoMid: BeatEvent[] = [
  ...phrase("b1", 12, "[1,3]/0.75 1/0.25 0 3/0.5 4/0.25"),
  ...trill("b2", 14, "1/0.25 0/0.5 1/0.25 0 4/0.5 3/0.25"),
  ...phrase("b3", 16, "2h/0.5 r/0.25 1 2/0.75 0 1/0.25 2 1/0.5 1"),
  ...phrase("b4", 20, "[2,3]/0.5 1/0.25 2 1/0.5 1/0.25 4"),
  ...phrase("b5", 22, "2/0.5 1/0.25 0 1/0.5 2/0.25 4"),
  ...phrase("b6", 24, "1/0.5 2/0.25 3 2 3/0.5 2/0.25"),
  ...trill("b7", 26, "1/0.25 2/0.5 3/0.25 0 3/0.5 4/0.25"),
];
const virtuosoClose: BeatEvent[] = [
  ...phrase("c1", 28, "[1,3]/0.5 2/0.25 1 0/0.5 2"),
  ...phrase("c2", 30, "3/0.5 2/0.25 1 2/0.5 1"),
  ...phrase("c3", 32, "[1,3]/0.5 0/0.25 1 2/1"),
];
const virtuosoEpisode: BeatEvent[] = [
  ...phrase("d1", 34, "0h!/1 r/0.5 4/0.25 3 | [1,4]!/0.5 3 3h r"),
  ...phrase("d2", 38, "1h/1.25 r/0.25 0 1/0.75 | 2/0.5 3 4/0.25 3"),
  ...phrase("d3", 42, "2/0.5 1/0.25 2 1/0.5 3"),
  ...phrase("d4", 44, "[1,3]/0.5 4h r 3 4 2 1 2"),
  ...phrase("d5", 48, "3h/0.5 r/0.25 1 2/0.5 1/0.25 2"),
  ...phrase("d6", 50, "3/0.5 2/0.25 1 0/0.5 0"),
  ...phrase("d7", 52, "[2,3]/0.5 1/0.25 2 1/0.5 1/0.25 4"),
  ...phrase("d8", 54, "2/0.5 1/0.25 0 1/0.5 2/0.25 4"),
  ...phrase("d9", 56, "1/0.5 2/0.25 3 2 3/0.5 2/0.25"),
  ...trill("d10", 58, "1/0.25 2/0.5 3/0.25 0 3/0.5 4/0.25"),
  ...phrase("d11", 60, "3/0.5 2/0.25 1 0/0.5 2"),
  ...phrase("d12", 62, "3!/0.5 0/0.25 1 2/0.5 4"),
  ...phrase("d13", 64, "[1,4]!/0.5 3/0.25 2 3h/0.5 r 0h/1.75 r/0.25"),
];
const virtuosoArpeggios: BeatEvent[] = [
  ...phrase("e1", 68, "0/0.5 1/0.25 2 3/0.5 4"),
  ...phrase("e2", 70, "1/0.5 4/0.25 3 4/0.5 1"),
  ...phrase("e3", 72, "0h/0.5 r/0.25 3 4/0.5 2 1 4/0.25 3 4/0.5"),
  ...phrase("e4", 75.5, "0/0.5 | [1,3] 2 3 4"),
  ...phrase("e5", 78, "3/0.5 2 3 4"),
  ...phrase("e6", 80, "3h/0.5 r 2 3/0.25 2 1/0.5 0/0.25 1 2/0.5"),
  ...phrase("e7", 83.5, "2/0.5 | 1h!/1 r/0.5 3 2 0/0.25 1 2/0.5 3"),
];
const virtuosoReturn: BeatEvent[] = [
  ...
  ...trill("f7", 102, "1/0.25 0/0.5 2/0.25 1 4/0.5 3/0.25"),
  ...phrase("f8", 104, "4!/0.5 1/0.25 2 1/0.5 1/0.25 0"),
  ...phrase("f9", 106, "1/0.5 1/0.25 4 2/0.5"),
];
...
// Maestro: every sixteenth of the running bars, chords on the harmonic
// accents and counterpoint fragments where the top line rests.
const maestroHead: BeatEvent[] = [
  ...phrase("a1", 3.5, "4/0.25 3 | [1,4]!/0.5 2/0.25 1 2/0.5 4/0.25 3"),
  ...phrase("a2", 6, "4/0.5 1/0.25 0 1/0.5 4/0.25 3"),
  ...phrase("a3", 8, "4h/0.5 r/0.25 0 1/0.5 2 0/0.25 3 0 3"),
...
const maestroEpisode: BeatEvent[] = [
  ...
  ...phrase("d14", 64, "[2,3]!/0.5 3/0.25 2 3h/0.5 r 0h/1.75 r/0.25"),
];
const maestroArpeggios: BeatEvent[] = [
  ...
  ...phrase("e6", 80, "3h/0.5 r 2/0.25 3 2 1"),
  ...phrase("e7", 82, "0/0.5 1/0.25 2 3 2 1/0.5"),
  ...phrase("e8", 84, "0h!/1 r/0.5 3 1/0.25 4 0 3 1 3"),
